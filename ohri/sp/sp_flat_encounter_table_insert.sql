...
BEGIN
    ...
    SET @column_list = (SELECT GROUP_CONCAT(column_label SEPARATOR ', ')
    ...
    SET @insert_stmt = CONCAT(
            'INSERT INTO `', @tbl_name ,'` (encounter_id, client_id, ',@column_list,') SELECT eo.encounter_id, eo.person_id, ', @column_labels, '
