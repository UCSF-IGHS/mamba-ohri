...
TRUNCATE TABLE  [derived_recency].fact_recency_surveillance;
...
FROM 
    ...
    LEFT JOIN derived_recency.dim_client c
        ON e.facility_id = c.registering_facility_id
        AND e.serial_number = c.hts_number_hts_client_card;
